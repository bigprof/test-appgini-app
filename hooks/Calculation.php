<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Calculation' table. 
	...
	*/
	...
	function Calculation_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function Calculation_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function Calculation_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function Calculation_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function Calculation_batch_actions(&$args) {
