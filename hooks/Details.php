<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Details' table. 
	...
	*/
	 ...
	 *     $data['Due_Date'], $data['Domain'], $data['Sub_Domains'], $data['Crazy_Domains'], $data['DNS_Provider'], $data['Yearly_Fee'], $data['Company_Name'], $data['Contact'], $data['Email_Address'], $data['Alternative_Email'], $data['Notes']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['ID'], $data['Due_Date'], $data['Domain'], $data['Sub_Domains'], $data['Crazy_Domains'], $data['DNS_Provider'], $data['Yearly_Fee'], $data['Company_Name'], $data['Contact'], $data['Email_Address'], $data['Alternative_Email'], $data['Notes']
