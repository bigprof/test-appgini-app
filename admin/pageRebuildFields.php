	...
	*/
	...
	$schema = array(
		'Details' => array(
			...
			'Due_Date' => array('appgini' => 'VARCHAR(15) null '),
			'Domain' => array('appgini' => 'VARCHAR(60) null '),
			'Sub_Domains' => array('appgini' => 'TEXT null '),
			'Crazy_Domains' => array('appgini' => 'VARCHAR(20) null '),
			'DNS_Provider' => array('appgini' => 'VARCHAR(40) null '),
			'Yearly_Fee' => array('appgini' => 'DECIMAL(10,2) null default \'0.00\' '),
			'Company_Name' => array('appgini' => 'VARCHAR(40) null '),
			'Contact' => array('appgini' => 'VARCHAR(40) null '),
			'Email_Address' => array('appgini' => 'VARCHAR(40) null '),
			'Alternative_Email' => array('appgini' => 'VARCHAR(40) null '),
			'Notes' => array('appgini' => 'TEXT null '),
		),
		'Calculation' => array(
			'ID2' => array('appgini' => 'VARCHAR(40) not null primary key '),
